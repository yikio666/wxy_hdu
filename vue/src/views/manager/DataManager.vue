<template>
    <div>
        <div style="display: flex; grid-gap: 10px">
            <div className="card" style="padding: 20px; flex: 1; display: flex">
        ...
        <div style="margin-top: 10px; display: flex; grid-gap: 10px">
            <div id="line" style="flex: 1; padding: 20px; height: 500px" className="card"></div>
            <div id="pie" style="flex: 1; padding: 20px; height: 500px" className="card"></div>
        </div>
